...
def filter_dets(boxes, obj_scores, obj_classes, rel_inds, pred_scores, rel_dists= None, save_entry = None):
    """
    Filters detections....
    ...
    return boxes_out, objs_np, obj_scores_np, rels, pred_scores_sorted, rel_dists, rel_inds, save_entry
